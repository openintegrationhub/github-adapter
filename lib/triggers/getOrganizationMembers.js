...
async function processTrigger(msg, cfg) {
    ...
    // Fetch all members from the previously fetched organizations
    ...
    /** The following block (L86 - L98) creates the meta object.  
    ...
    /** Iterates through all received organizations and emits each object one-by-one.
